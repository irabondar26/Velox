...
export default function Hero() {
    return (
        <section className="relative mb-10">
            ...
            <div className="hidden absolute top-[35%] right-[10%] py-1 pl-1 pr-2 rounded-full justify-center items-center gap-x-1  bg-cyan-950 opacity-80 sm:inline-flex md:py-2 md:pl-2 md:pr-5 md:gap-x-2.5">
